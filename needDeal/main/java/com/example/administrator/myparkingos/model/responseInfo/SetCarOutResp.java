...
public class SetCarOutResp
{
    ...
    public static class DataBean
    {
        ...
        public String toString()
        {
            ...
            sb.append(", SimilarCPHInPark=").append(SimilarCPHInPark);
            sb.append(", SimilarCPHIssued=").append(SimilarCPHIssued == null ? "null" : Arrays.asList(SimilarCPHIssued).toString());
            sb.append('}');
            return sb.toString();
        }
        ...
        public String[] getSimilarCPHIssued()
        {
            return SimilarCPHIssued;
        }

        public void setSimilarCPHIssued(String[] similarCPHIssued)
        {
