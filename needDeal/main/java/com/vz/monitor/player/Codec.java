...
public class Codec {
	...
	public static final int CODEC_JPEG			= 2;
	public static final int CODEC_G711			= 3;
	public static final int CODEC_G726			= 4;
	public static final int CODEC_G729			= 5;
	...
	public  int decodeVideo(byte[] src, int length, byte[] dst,int[] wah,int codetype) {
		...
		switch (videoCodecType) {
		case CODEC_H264:
			result = h264.decode(handle,src, length, dst,wah,codetype);
		default:
			break;
		}
		return result;
