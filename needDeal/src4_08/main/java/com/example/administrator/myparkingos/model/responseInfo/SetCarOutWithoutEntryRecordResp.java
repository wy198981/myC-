...
public class SetCarOutWithoutEntryRecordResp
{
    ...
    public static class DataBean
    {
        ...
        private String[] SimilarCPHArray; // N 类似车牌列表。当按参数CPH传入的车牌号找不到场内记录时，此字段中保存场内车辆相似的车牌的数组。
        ...
        public String toString()
        {
            ...
            sb.append(", SimilarCPHArray=").append(SimilarCPHArray == null ? "null" : Arrays.asList(SimilarCPHArray).toString());
            sb.append('}');
            return sb.toString();
        }
        ...
        public String[] getSimilarCPHArray()
        {
            return SimilarCPHArray;
        }

        public void setSimilarCPHArray(String[] similarCPHArray)
        {
            SimilarCPHArray = similarCPHArray;
        }
    }
