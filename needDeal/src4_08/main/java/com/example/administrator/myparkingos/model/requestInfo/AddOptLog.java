...
public class AddOptLog
{
    ...
    public AddOptLog(int ID, int stationID, String optNO, String userName, String optMenu, String optContent, String optTime, Object PCName, int carparkNO)
    {
        this.ID = ID;
        StationID = stationID;
        OptNO = optNO;
