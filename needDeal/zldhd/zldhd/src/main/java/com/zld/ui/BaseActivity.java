...
//		getLocalOrderDBManager();
    ...
    public void changeEquipment(EditText edit, boolean boo)
    {
        ...
        if (!equipmentModel.equals("MI PAD"))
        {//小米平板
            Log.e(TAG, "电视棒");
            //编辑框屏蔽输入法
    ...
    public void showToast(String text)// Toast 的设置
    {
        if (mToast == null)
        {
...
//			ShowDialog.buildeChooseDialog((Activity)context, "当前网络不可用", "停车宝提示");
    ...
    public boolean doSucess(
            String url, boolean isSingle, String passid,
    ...
    @Override
    public boolean doSucess(
            String url, String object, byte[] buffer,
    ...
    @Override
    public boolean doSucess(
            String url, String object, String username,
    ...
    @Override
    public boolean doSucess(
            String requestUrl, String username2,
    ...
    @Override
    public boolean doSucess(
            String requestUrl, byte[] buffer, String username2,
            String password2
    )
    {
        // TODO Auto-generated method stub
