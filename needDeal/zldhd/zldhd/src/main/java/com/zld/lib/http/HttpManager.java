...
//		});
    ...
    public static void requestGET(
            final Context context, final String requestUrls, final String str,
    ...
    public static void requestGET(
            final Context context, final String requestUrls, final String str1, final String str2,
            final HttpCallBack callBack
    )
    {
        final String requestUrl = requestUrls + "&r=" + Math.random();
    ...
    public static void requestGET(
            final Context context, final String requestUrls, final byte[] buffer,
    ...
    public static void requestCominfoGET(
            final Context context, final String requestUrl, final HttpCallBack callBack,
    ...
    public static void isInternet(Context context)
    {
        ...
        {
            // 是否是本地服务器
            if (!AppInfo.getInstance().getIsLocalServer(context))
            {// 是本地服务器则没有平板本地化的感念
                // 当前网络不可用
